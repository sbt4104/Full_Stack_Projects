...
export class SearchComponent implements OnInit {
  ...
  constructor(private route:MyRouteService ,private watchlistservice:WatchlistService,private routeobj: RoutingService) { 
  ...
  actionMethod(pos:any)
  {
    ...
    this.watchlistservice.addStock(this.routeobj.getid(),data).subscribe();
